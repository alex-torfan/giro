...
<div id="contenidoPagina" class="servicios">
	<div class="giroWidth centered" style="display: table;">
<div class="menuLateral">
	<ul>
		<li class="seleccionado"><a href="#admin"><s:text name="pagina-servicios.administracion-fincas-parkings" /></a></li>
	<li><a href="#empresas"><s:text name="pagina-servicios.autonomos-empresas" /></a></li>
	<li><a href="#otros"><s:text name="pagina-servicios.otros-servicios" /></a></li>
	</ul>
</div>
<div class="content desgloseServicios">
	<div class="intro">
		<h1><s:text name="pagina-servicios.titulo" /></h1>
	<p><s:text name="pagina-servicios.descripcion" /></p>
</div>
<div class="content expandable" id="admin">
	<blockquote>
		<div class="box">
	...
	<div class="letraPequenya"><s:text name="pagina-servicios.mas-informacion" /> <a href="${urlQuienesSomos}">aqu&iacute;</a>.</div>
</div>
<div class="content expandable" id="empresas">
	<blockquote>
		<div class="box">
...
<div class="content expandable" id="otros">
	<blockquote>
		<div class="box">
			<div class="title"><s:text name="pagina-servicios.otros-servicios.punto1" /></div><br/>
			<div class="title"><s:text name="pagina-servicios.otros-servicios.punto2" /></div><br/>
...
<div class="content">
	...
	<div class="desgloseServicios" id="accordion">
		<div class="title expandable"><span><s:text name="pagina-servicios.administracion-fincas-parkings" /></span><span class="icono"></span></div>
		...
		<div class="title expandable"><span><s:text name="pagina-servicios.autonomos-empresas" /></span><span class="icono"></span></div>
		<div class="content expandable">
			<blockquote>
				<div class="box">
					<div class="title"><s:text name="pagina-servicios.servicio-contable" /></div>
		...
		<div class="title expandable"><span><s:text name="pagina-servicios.otros-servicios" /></span><span class="icono"></span></div>
		<div class="content expandable">
			<blockquote>
				<div class="box">
					<div class="title"><s:text name="pagina-servicios.otros-servicios.punto1" /></div><br/>
...
function makeMenuFunctionality() {
	$(".menuLateral li a").unbind().click(mostrarSeccion);
	var url = location.href;
	if (url.indexOf("#") != -1) {
		var seccion = url.substring(url.indexOf("#") + 1, url.length);
		$(".menuLateral li a[href=#" + seccion + "]").click();
	}
}
...
function mostrarSeccion_1() {
	var anchor = $(this);
	var seccion = $(anchor.attr("href"));
	var seccionActual = $(".content.expandable:visible");
	var introMostrada = $(".desgloseServicios > .intro");
	if (seccionActual.html() != null) {
		console.log("seccion");
		//seccionActual.stop().hide("slide", { direction: "up" }, 600);
		seccionActual.stop().animate({"height" : "toggle"}, 600);
	} else if (introMostrada.is(":visible")) {
		console.log("introduccion");
		//introMostrada.stop().hide("slide", { direction: "up" }, 600);
		introMostrada.stop().animate({"height" : "toggle"}, 600);
	}
	//seccion.show("slide", { direction: "down" }, 600);
	seccion.stop().animate({"height" : "toggle"}, 600);
	$(".menuLateral li").removeClass("seleccionado");
